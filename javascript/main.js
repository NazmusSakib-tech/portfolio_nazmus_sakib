(function ($) {
  ...
  jQuery(window).on("load", function () {
    ...
    var commonCards =
      ...
      "#portfolios-card,#interest-card,#p-one,#p-two,#p-three,#blog-card,#contact-card,#clients,.section-title img, .img-container, .portfolio-item0, .portfolio-item1, .portfolio-item2";
