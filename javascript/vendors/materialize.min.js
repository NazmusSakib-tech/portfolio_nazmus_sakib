...
(jQuery.easing.jswing = jQuery.easing.swing),
          ...
          (i.isWindow = function (t) {
            ...
            (i.each = function (t, i, n) {
              ...
              if (n) {
                ...
                for (r in t) if (((a = i.call(t[r], r, t[r])), a === !1)) break;
              return t;
            }),
            ...
            (i.queue = function (t, n, a) {
              ...
              if (t) {
                ...
                var o = i.data(t, n);
                return a
                  ? (!o || i.isArray(a) ? (o = i.data(t, n, r(a))) : o.push(a),
                    o)
                  : o || [];
              }
            }),
            ...
            if (t) {
              ...
              for (var r = 0; i > r; r++)
                if (b.State.calls[r]) {
                  ...
                  for (
                    var m = Math.min((e - f) / u.duration, 1),
                      y = 0,
                      w = l.length;
                    w > y;
                    y++
                    ...
                    if (o(T)) {
                      ...
                      u.visibility !== n &&
                        "hidden" !== u.visibility &&
                        x.setPropertyValue(T, "visibility", u.visibility);
                      for (var O in C)
                        if ("element" !== O) {
                          var A,
                            E = C[O],
                            q = v.isString(E.easing)
                              ? b.Easings[E.easing]
                              : E.easing;
                          if (1 === m) A = E.endValue;
                          else {
                          ...
                          if (((E.currentValue = A), "tween" === O)) g = A;
                            ...
                            x.Hooks.registered[O] &&
                              (o(T).rootPropertyValueCache[V] = x.Normalizations
                                .registered[V]
                                ? x.Normalizations.registered[V](
                                    "extract",
                                    null,
                                    _[1]
                                  )
                      ...
                      u.mobileHA &&
                        o(T).transformCache.translate3d === n &&
                        ((o(T).transformCache.translate3d = "(0px, 0px, 0px)"),
                        (S = !0)),
            ...
            for (
              ...
              if (
                ...
                p.each(x.Lists.transforms3D, function (t, e) {
                  ...
                  r.mobileHA &&
                    ((f = !0), delete o(d).transformCache.translate3d),
              ...
              s && r.loop !== !0 && s(a),
                o(d) &&
                  r.loop === !0 &&
                  !e &&
                  (p.each(o(d).tweensContainer, function (t, e) {
                    /^rotate/.test(t) &&
            ...
            getPropertyValue: function (t, i, a, r) {
                ...
                if (8 >= f) l = p.css(t, i);
                  ...
                  if (
                    ...
                    if (
                      ...
                      var c =
                        t.offsetHeight -
                        (parseFloat(x.getPropertyValue(t, "borderTopWidth")) ||
                          0) -
                        (parseFloat(
                  ...
                  (h =
                    ...
                    (l =
                      9 === f && "filter" === i ? h.getPropertyValue(i) : h[i]),
              ...
              if (x.Hooks.registered[i]) {
                var u = i,
                  c = x.Hooks.getRoot(u);
                a === n &&
                  (a = x.getPropertyValue(t, x.Names.prefixCheck(c)[0])),
              ...
              function t(t) {
                ...
                function m() {
                  ...
                  if (a && n)
                    ...
                    b.init(u),
                      ...
                      (l.percentToPxHeight = _.lastPercentToPxHeight =
                        (parseFloat(
                          x.getPropertyValue(u, "height", null, !0)
                        ) || 1) / s),
                      (l.emToPx = _.lastEmToPx =
                        (parseFloat(x.getPropertyValue(u, "paddingLeft")) ||
                          1) / s),
                ...
                if ("scroll" === A) {
                  ...
                  s.container
                    ? v.isWrapped(s.container) || v.isNode(s.container)
                      ? ((s.container = s.container[0] || s.container),
                        ...
                        (P = C + p(r).position()[E.toLowerCase()] + q))
                      : (s.container = null)
                    : ((C =
                        b.State.scrollAnchor[b.State["scrollProperty" + E]]),
                      (S =
                        b.State.scrollAnchor[
                          b.State[
                  ...
                  "none" === o(r).opts.display && (o(r).opts.display = "auto"),
                    "hidden" === o(r).opts.visibility &&
                      (o(r).opts.visibility = "visible"),
                    (o(r).opts.loop = !1),
                    (o(r).opts.begin = null),
                  ...
                  o(r).tweensContainer &&
                    o(r).isAnimating === !0 &&
                    (M = o(r).tweensContainer),
                    p.each(g, function (t, e) {
                      if (
                        RegExp("^" + x.Lists.colors.join("$|^") + "$").test(t)
                      ) {
                        var i = d(e, !0),
                          a = i[0],
                          r = i[1],
                  ...
                  for (var D in g) {
                    ...
                    if (
                      ...
                      ((s.display !== n &&
                        ...
                        0 !== Q &&
                        (N = 0),
                        s._cacheValues && M && M[D]
                          ? (N === n && (N = M[D].endValue + M[D].unitType),
                            (F = o(r).rootPropertyValueCache[$]))
                          : x.Hooks.registered[D]
                          ? N === n
                            ? ((F = x.getPropertyValue(r, $)),
                              (N = x.getPropertyValue(r, D, F)))
                            : (F = x.Hooks.templates[$][1])
                          : N === n && (N = x.getPropertyValue(r, D));
                      var W,
                        R,
                        H,
                        X = !1;
                ...
                l.element &&
                  ...
                  j.push(l),
                  "" === s.queue &&
                    ((o(r).tweensContainer = l), (o(r).opts = s)),
                  (o(r).isAnimating = !0),
                  T === k - 1
                    ? (b.State.calls.push([j, h, s, null, O.resolver]),
                      b.State.isTicking === !1 &&
              ...
              b.mock !== !1 &&
                ...
                s.queue === !1
                  ? s.delay
                    ...
                    : t()
                  : p.queue(r, s.queue, function (e, i) {
                      return i === !0
                        ? (O.promise && O.resolver(h), !0)
            ...
            if (
              ...
              if (!/^(stop|finish)$/i.test(g) && !p.isPlainObject(y)) {
                ...
                for (var P = S; P < arguments.length; P++)
                  v.isArray(arguments[P]) ||
                  (!/^(fast|normal|slow)$/i.test(arguments[P]) &&
                    !/^\d/.test(arguments[P]))
                    ? v.isString(arguments[P]) || v.isArray(arguments[P])
                      ? (y.easing = arguments[P])
                      : v.isFunction(arguments[P]) &&
                        (y.complete = arguments[P])
                    : (y.duration = arguments[P]);
              }
              var O = { promise: null, resolver: null, rejecter: null };
              s &&
                b.Promise &&
                (O.promise = new b.Promise(function (t, e) {
              ...
              switch (g) {
                ...
                default:
                  if (!p.isPlainObject(g) || v.isEmptyObject(g)) {
                      ...
                      return (
                        ...
                        p.each(h, function (t, e) {
                          parseFloat(q.stagger)
                            ? (q.delay = V + parseFloat(q.stagger) * t)
                            : v.isFunction(q.stagger) &&
                              (q.delay = V + q.stagger.call(e, t, k)),
                            q.drag &&
                              ((q.duration =
                                parseFloat(M) ||
                    ...
                    return (
                      O.promise ? O.rejecter(new Error(I)) : console.log(I), t()
                    );
                  }
                  A = "start";
              }
              ...
              var D,
                q = p.extend({}, b.defaults, y);
              if (((q.loop = parseInt(q.loop)), (D = 2 * q.loop - 1), q.loop))
                for (var z = 0; D > z; z++) {
                  var Q = { delay: q.delay, progress: q.progress };
                  z === D - 1 &&
                    ((Q.display = q.display),
              ...
              i.addEventListener("visibilitychange", function () {
                i.hidden
                  ? ((k = function (t) {
                    ...
                    c())
                  : (k = e.requestAnimationFrame || h);
              }),
            (t.Velocity = b),
            t !== e &&
              ((t.fn.velocity = C), (t.fn.velocity.defaults = b.defaults)),
  ...
  !(function (t, e, i, n) {
    ...
    var Qt = { mousedown: Tt, mousemove: St, mouseup: Pt },
      Lt = "mousedown",
    ...
    var Ht = { touchstart: Tt, touchmove: St, touchend: Pt, touchcancel: Ot },
      Xt = "touchstart",
    ...
    (Y.prototype = {
      ...
      u(tt, Y, {
        ...
        process: function (t) {
          ...
          if (((this._input = t), !n || !i || (t.eventType & (Pt | Ot) && !r)))
            this.reset();
      ...
      recognize: function (t) {
        ...
        if (!e.stopped) {
          ...
          for (var r = 0; r < n.length; )
            (i = n[r]),
              e.stopped === pe || (a && i != a && !i.canRecognizeWith(a))
                ? i.reset()
                : i.recognize(t),
            ...
            o.on("click.collapse", "> li > .collapsible-header", function (o) {
              ...
              a(u) && (u = r(u)),
                ...
                e.accordion || "accordion" === l || void 0 === l
                  ? i(u)
                  : (n(u), s.hasClass("active") && n(s));
            });
          var s = o.find("> li > .collapsible-header");
          e.accordion || "accordion" === l || void 0 === l
            ? i(s.filter(".active").first())
      ...
      (t.fn.dropdown = function (e) {
        ...
        this.each(function () {
          ...
          function a(e) {
            ...
            if (
              (s.belowOrigin === !0 && (f = r),
              c + u.innerWidth() > t(window).width()
                ? (p = "right")
                : c - u.innerWidth() + o.innerWidth() < 0 && (p = "left"),
              d + u.innerHeight() > a)
            )
            ...
            if ("left" === p)
              (i = s.gutter), (leftPosition = o.position().left + i);
            else if ("right" === p) {
          ...
          if ((n(), o.after(u), s.hover)) {
            ...
            o.unbind("click." + o.attr("id")),
              ...
              o.on("mouseleave", function (e) {
                ...
                t(i).closest(".dropdown-content").is(u) ||
                  (u.stop(!0, !0), r(), (c = !1));
              }),
              u.on("mouseleave", function (e) {
                var i = e.toElement || e.relatedTarget;
                t(i).closest(".dropdown-button").is(o) ||
                  (u.stop(!0, !0), r(), (c = !1));
              });
          } else
            o.unbind("click." + o.attr("id")),
                ...
                l ||
                  ...
                  0 !== t(e.target).closest(".dropdown-content").length
                    ? o.hasClass("active") &&
                      (r(),
                      t(document).unbind(
                        "click." + u.attr("id") + " touchstart." + u.attr("id")
                      ))
        ...
        closeModal: function (i) {
          ...
          (i = t.extend(n, i)),
            ...
            a.hasClass("bottom-sheet")
              ...
              : a.velocity(
                  { top: i.starting_top, opacity: 0, scaleX: 0.7 },
                  {
                    duration: i.out_duration,
                    complete: function () {
        ...
        if (!t(this).hasClass("initialized")) {
          ...
          l.wrap(u),
            l.on("click", function () {
              ...
              l.css({ position: "absolute", "z-index": 1e3 })
                .data("width", d)
                .data("height", p);
              ...
              var g = 0,
                ...
                w = 0;
              m > y
                ? ((g = p / d), (b = 0.9 * u), (w = 0.9 * u * g))
                : ((g = d / p), (b = 0.9 * c * g), (w = 0.9 * c)),
      ...
      return this.each(function (i) {
        function n(i) {
          ...
          i && r.css("display", "block"),
            l > c &&
              c + d > u &&
              r.css("transform", "translate3D(-50%," + h + "px, 0)");
        }
        var a = t(this);
        a.addClass("parallax"),
          a
  ...
  (function (t) {
                  ...
                  (u = setTimeout(function () {
                    ...
                    "top" === d
                      ...
                      : ((t = r.offset().top + r.outerHeight() + n),
                        ...
                        (a = e(i, t, f, p)),
                        (h = "+10px"),
                        l.css({ marginLeft: f / 2 - l.width() / 2 })),
                      s.css({ top: a.y, left: a.x }),
                      (g = f / 8),
                      8 > g && (g = 8),
                      ("right" === d || "left" === d) &&
                        ((g = f / 10), 6 > g && (g = 6)),
    ...
    var e = function (e, i, n, a) {
      ...
      return (
        0 > r
          ? (r = 4)
          : r + n > window.innerWidth && (r -= r + n - window.innerWidth),
        0 > o
          ? (o = 4)
          : o + a > window.innerHeight + t(window).scrollTop &&
            (o -= o + a - window.innerHeight),
        { x: r, y: o }
      );
    };
    t(document).ready(function () {
      ...
      init: function (e) {
        ...
        (e = t.extend(i, e)),
          t(this).each(function () {
            ...
            t("body").append(r),
              "left" == e.edge
                ? (a.css("left", -1 * (e.menuWidth + 10)), r.css({ left: 0 }))
                : (a
                    .addClass("right-aligned")
                    .css("right", -1 * (e.menuWidth + 10))
                    .css("left", ""),
                  r.css({ right: 0 })),
              a.hasClass("fixed") &&
              ...
              a.hasClass("fixed") &&
                t(window).resize(function () {
                  window.innerWidth > 992
                    ? 0 !== t("#sidenav-overlay").css("opacity") && s
                      ? i(!0)
                      : (a.removeAttr("style"), a.css("width", e.menuWidth))
                    : s === !1 &&
                      ("left" === e.edge
                        ? a.css("left", -1 * (e.menuWidth + 10))
                        : a.css("right", -1 * (e.menuWidth + 10)));
                }),
              e.closeOnClick === !0 &&
                a.on(
                  "click.itemclick",
                ...
                .bind("pan", function (n) {
                  if ("touch" == n.gesture.pointerType) {
                    ...
                    if (
                      ...
                      r < window.innerWidth - e.menuWidth / 2
                        ? (s = !0)
                        : r >= window.innerWidth - e.menuWidth / 2 && (s = !1);
        ...
        t(this).each(function () {
          ...
          if (!n.hasClass("browser-default")) {
            ...
            n.before(g),
              g.before(h),
              g.after(l),
              n.is(":disabled") || g.dropdown({ hover: !1, closeOnClick: !1 }),
              n.attr("tabindex") &&
    ...
    function e(r, o, l, d) {
      function p() {
        return e._.node(
          ...
          e._.node(
            ...
            e._.node(
              "div",
              e._.node("div", T.component.nodes(b.open), x.box),
              x.wrap
            ),
            x.frame
          ),
      ...
      function f() {
        C.data(o, T)
          .addClass(x.input)
          .attr("tabindex", -1)
          .val(C.data("value") ? T.get("select", w.format) : r.value),
          w.editable ||
            C.on("focus." + b.id + " click." + b.id, function (t) {
            ...
            "mousedown click": function (e) {
              ...
              i != T.$root.children()[0] &&
                ...
                "mousedown" != e.type ||
                  ...
                  (e.preventDefault(), T.$root[0].focus()));
            },
          })
          .on({
            focus: function () {
      ...
      var y = !1,
        ...
        T = (k.prototype = {
          ...
          close: function (t) {
            return (
              t &&
                (T.$root.off("focus.toOpen")[0].focus(),
                setTimeout(function () {
          ...
          set: function (e, i, n) {
            ...
            if (((n = o && t.isPlainObject(i) ? i : n || {}), e)) {
              ...
              for (a in s)
                (r = s[a]),
                  a in T.component.item &&
                    (void 0 === r && (r = null), T.component.set(a, r, n)),
                  ("select" == a || "clear" == a) &&
                    C.val("clear" == a ? "" : T.get(a, w.format)).trigger(
                      "change"
                    );
              T.render();
            }
        ...
        return (
          ...
          r.node(
            ...
            r.node("div", createWeekdayLabel(), "picker__weekday-display") +
              r.node("div", g("short_months"), i.klass.month_display) +
